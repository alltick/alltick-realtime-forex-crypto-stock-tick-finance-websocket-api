...
| Text          | Text                                                         | Text                                                         |
| ------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Free          | 1、Once every 10 seconds, only 1 request can be made <br />2、5 products per batch max | 1、One request per second.<br />2、/batch-kline needs 10-second intervals.<br />3、Total of 10 requests per minute (every 6 seconds).<br />4、Max 1000 daily requests; excess resets at midnight. |
