...
| ------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Free          | **/kline API**：1 request per 10 seconds<br /> **/batch-kline API**：1 request per 10 seconds<br /> **/depth-tick API**：1 request per 10 seconds<br /> **/trade-tick API**：1 request per 10 seconds<br /> **/static_info API**：1 request per 10 seconds | 1、One request per second.<br />2、/batch-kline needs 10-second intervals.<br />3、Total of 10 requests per minute (every 6 seconds).<br />4、Max 14400 daily requests; excess resets at midnight. |
