...
| :------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| 免费     | **/kline接口**：每10秒，只能1次请求<br /> **/batch-kline接口**：每10秒，可1次请求<br /> **/depth-tick接口**：每10秒，只能请求1次<br /> **/trade-tick接口**：每10秒，只能请求1次<br /> **/static_info接口**：每10秒，只能1次请求 | 1、同1秒只能请求1个接口<br />2、需注意/batch-kline接口需间隔10秒<br /> 3、所有接口相加，1分钟最大请求10次(6秒1次)<br /> 4、每天总共最大可请求14400次，超过则第二天凌晨恢复使用 |
