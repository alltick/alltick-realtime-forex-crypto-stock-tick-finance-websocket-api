...
| 基础     | 1、每3秒，只能1次请求<br /> 2、每次可批量查询100，100=产品数量*K线类型 | 1、同1秒只能请求1个接口<br /> 2、所有接口相加，1分钟最大请求60次(1秒1次)，需注意/batch-kline接口需间隔3秒 |
| 高级     | 1、每2秒，只能1次请求<br /> 2、每次可批量查询200，200=产品数量*K线类型 | 所有接口相加，1分钟最大请求600次(1秒10次)，需注意/batch-kline接口需间隔2秒 |
| 专业     | 1、每1秒，只能1次请求<br /> 2、每次可批量查询500，500=产品数量*K线类型 | 所有接口相加，1分钟最大请求1200次(1秒20次)，需注意/batch-kline接口需间隔1秒 |
| 全部港股 | 1、每1秒，只能1次请求<br /> 2、每次可批量查询500，500=产品数量*K线类型 | 所有接口相加，1分钟最大请求1200次(1秒20次)，需注意/batch-kline接口需间隔1秒 |
| 全部A股  | 1、每1秒，只能1次请求<br /> 2、每次可批量查询500，500=产品数量*K线类型 | 所有接口相加，1分钟最大请求1200次(1秒20次)，需注意/batch-kline接口需间隔1秒 |
| 全部美股 | 1、每1秒，只能1次请求<br /> 2、每次可批量查询500，500=产品数量*K线类型 | 所有接口相加，1分钟最大请求1200次(1秒20次)，需注意/batch-kline接口需间隔1秒 |
